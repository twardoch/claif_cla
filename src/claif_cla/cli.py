...
class ClaudeCLI:
    ...
    def benchmark(
        ...
        """
        console.print(f"[bold]Benchmarking Claude[/bold]")
    ...
    def interactive(self, session: Optional[str] = None) -> None:
        ...
        console.print(f"[bold]Interactive Claude Session[/bold]")
    ...
    def _handle_command(self, command: str, session_id: str) -> None:
        ...
        if cmd == "/help":
            ...
            system = " ".join(parts[1:])
            console.print(f"[green]System prompt set[/green]")
